...
#if defined(CFG_DM365_EVM) || defined(CFG_DM365_IPNC) || defined(CFG_DM368_IPNC) || defined(CFG_DM368_IPNC)
...
#elif defined(CFG_DM365_EVM) || defined(CFG_DM365_IPNC) || defined(CFG_DM368_IPNC)
/* MDIO module input frequency */
...
#if defined(CFG_DM6467_EVM) || defined(CFG_DM365_EVM) || defined(CFG_DM365_IPNC) || defined(CFG_DM368_IPNC)
typedef struct  {
	dv_reg		IDVER;
	dv_reg		SOFTRST;
	dv_reg		EMCTRL;
