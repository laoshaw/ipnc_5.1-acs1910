...
#define CONFIG_IDENT_STRING " DM365-IPNC-5.1.0"
...
#define CONFIG_BOOTARGS		"mem=60M console=ttyS1,115200n8 root=/dev/ram0 rw initrd=0x82000000,11M ip=192.168.1.168:192.168.1.100:192.168.1.1:255.255.255.0:::off eth=$(ethaddr)"
