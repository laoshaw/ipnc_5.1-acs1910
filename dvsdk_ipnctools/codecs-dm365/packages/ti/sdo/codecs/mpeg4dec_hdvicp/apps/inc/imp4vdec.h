...
#ifndef __IMP4HDVICPDEC__
#define __IMP4HDVICPDEC__
...
enum IMP4HDVICPDEC_status_flags
{
    NO_FAULT,
    FAULT,
    FAULT_RVLC,
...
enum IMP4HDVICPDEC_extend_error
{
 ...
 *  ==========================================================================
 */
typedef struct IMP4HDVICPDEC_Obj
{
    struct IMP4HDVICPDEC_Fxns *fxns;
} IMP4HDVICPDEC_Obj;

/** ==========================================================================
 *  @name   IMP4HDVICPDEC_Handle
 *
 ...
 *  ==========================================================================
 */
typedef struct IMP4HDVICPDEC_Obj *IMP4HDVICPDEC_Handle;

/** ==========================================================================
 *  @name   IMP4HDVICPDEC_Status
 *
 ...
 *  ==========================================================================
 */
typedef struct IMP4HDVICPDEC_Status
{
 ...
 *  ==========================================================================
 */
typedef IVIDDEC2_Cmd IMP4HDVICPDEC_Cmd;

/** ==========================================================================
 *  @name   IMP4HDVICPDEC_Params
 *
 ...
 *  ==========================================================================
 */
typedef struct IMP4HDVICPDEC_Params
{
 ...
 *  ==========================================================================
 */
extern IMP4HDVICPDEC_Params IMPEG4VDEC_PARAMS;

/** ==========================================================================
 *  @name   IMP4HDVICPDEC_DynamicParams
 *
 ...
 *  ==========================================================================
 */
typedef struct IMP4HDVICPDEC_DynamicParams
{
 ...
 *  ==========================================================================
 */
typedef struct IMP4HDVICPDEC_InArgs
{
 ...
 *  ==========================================================================
 */
typedef struct IMP4HDVICPDEC_OutArgs
{
 ...
 *  ==========================================================================
 */
typedef struct IMP4HDVICPDEC_Fxns
{
...
#define IMP4HDVICPDEC_GETSTATUS      XDM_GETSTATUS
#define IMP4HDVICPDEC_SETPARAMS      XDM_SETPARAMS
#define IMP4HDVICPDEC_RESET          XDM_RESET
#define IMP4HDVICPDEC_FLUSH          XDM_FLUSH
#define IMP4HDVICPDEC_SETDEFAULT     XDM_SETDEFAULT
#define IMP4HDVICPDEC_GETBUFINFO     XDM_GETBUFINFO

/* Extending Chroma Formates                                                */
#define IMP4HDVICPDEC_YUV_420SP      XDM_YUV_420SP


#endif  /* __IMP4HDVICPDEC__ */
