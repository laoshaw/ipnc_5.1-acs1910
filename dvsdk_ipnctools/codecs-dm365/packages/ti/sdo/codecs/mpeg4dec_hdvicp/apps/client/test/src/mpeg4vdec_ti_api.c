 ...
 *          .
 *  @param  IMP4HDVICPDEC_Fxns  *fxns.:Handle to ALG functions
 *
 ...
 * ===========================================================================
 */
IMP4HDVICPDEC_Handle mp4VDEC_create(
                               const IMP4HDVICPDEC_Fxns   *fxns,
                               const IMP4HDVICPDEC_Params *prms
                              )
{
    IMP4HDVICPDEC_Handle handle;
    handle =  ((IMP4HDVICPDEC_Handle)ALG_create((IALG_Fxns   *)fxns, NULL,
                                           (IALG_Params *)prms));
    return handle;
} /* mp4VDEC_create() */
 ...
 * ===========================================================================
 */
Int mp4VDEC_control(IMP4HDVICPDEC_Handle        handle,
                    IMP4HDVICPDEC_Cmd           cmd,
                    IMP4HDVICPDEC_DynamicParams *params,
 ...
 * ===========================================================================
 */
void mp4VDEC_delete(IMP4HDVICPDEC_Handle handle)
{
 ...
 * ===========================================================================
 */
Int mp4VDEC_decode(IMP4HDVICPDEC_Handle  handle,
                   XDM1_BufDesc     *input,
                   XDM_BufDesc      *output,
                   IMP4HDVICPDEC_InArgs  *inarg,
                   IMP4HDVICPDEC_OutArgs *outarg)
{
    Int error;
