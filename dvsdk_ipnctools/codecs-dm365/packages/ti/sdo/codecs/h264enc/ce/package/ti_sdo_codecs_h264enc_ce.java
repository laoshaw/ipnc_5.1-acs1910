...
public class ti_sdo_codecs_h264enc_ce
{
    ...
    void H264ENC$$TYPES()
    {
        ...
        po.init("ti.sdo.codecs.h264enc.ce.H264ENC.Module", om.findStrict("ti.sdo.ce.video1.IVIDENC1.Module", "ti.sdo.codecs.h264enc.ce"));
        ...
        po.addFld("ialgFxns", $$T_Str, "H264VENC_TI_IH264VENC", "rh");
        po.addFld("iresFxns", $$T_Str, "H264VENC_TI_IRES", "rh");
