...
public class ti_sdo_codecs_mpeg4dec
{
    ...
    void MPEG4DEC$$TYPES()
    {
        ...
        po = (Proto.Obj)om.find("ti.sdo.codecs.mpeg4dec.MPEG4DEC.Module");
    ...
    void $$SINGLETONS()
    {
        pkgP.init("ti.sdo.codecs.mpeg4dec.Package", (Proto.Obj)om.find("xdc.IPackage.Module"));
    ...
    void MPEG4DEC$$SINGLETONS()
    {
        ...
        vo = (Value.Obj)om.find("ti.sdo.codecs.mpeg4dec.MPEG4DEC");
        po = (Proto.Obj)om.find("ti.sdo.codecs.mpeg4dec.MPEG4DEC.Module");
        vo.init2(po, "ti.sdo.codecs.mpeg4dec.MPEG4DEC", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", $$UNDEF);
        vo.bind("$package", om.find("ti.sdo.codecs.mpeg4dec"));
        tdefs.clear();
        proxies.clear();
        mcfgs.clear();
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.find("ti.sdo.codecs.mpeg4dec.MPEG4DEC"));
