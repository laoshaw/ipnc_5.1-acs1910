...
public class ti_sdo_codecs_mpeg4dec_ce
{
    ...
    void MPEG4DEC$$TYPES()
    {
        ...
        po = (Proto.Obj)om.find("ti.sdo.codecs.mpeg4dec.ce.MPEG4DEC.Module");
        po.init("ti.sdo.codecs.mpeg4dec.ce.MPEG4DEC.Module", om.find("ti.sdo.ce.video2.IVIDDEC2.Module"));
                po.addFld("$hostonly", $$T_Num, 1, "r");
                po.addFld("alg", (Proto)om.find("ti.sdo.codecs.mpeg4dec.MPEG4DEC.Module"), om.find("ti.sdo.codecs.mpeg4dec.MPEG4DEC"), "rh");
    ...
    void $$SINGLETONS()
    {
        pkgP.init("ti.sdo.codecs.mpeg4dec.ce.Package", (Proto.Obj)om.find("xdc.IPackage.Module"));
    ...
    void MPEG4DEC$$SINGLETONS()
    {
        ...
        vo = (Value.Obj)om.find("ti.sdo.codecs.mpeg4dec.ce.MPEG4DEC");
        po = (Proto.Obj)om.find("ti.sdo.codecs.mpeg4dec.ce.MPEG4DEC.Module");
        vo.init2(po, "ti.sdo.codecs.mpeg4dec.ce.MPEG4DEC", $$DEFAULT, false);
        vo.bind("Module", po);
        vo.bind("$category", "Module");
        vo.bind("$capsule", om.find("ti.sdo.codecs.mpeg4dec.ce.MPEG4DEC$$capsule"));
        vo.bind("$package", om.find("ti.sdo.codecs.mpeg4dec.ce"));
        tdefs.clear();
        proxies.clear();
        mcfgs.clear();
    ...
    void $$INITIALIZATION()
    {
        ...
        Global.callFxn("module$meta$init", (Scriptable)om.find("ti.sdo.codecs.mpeg4dec.ce.MPEG4DEC"));
