 ...
 *          details, refer to chanpter 8 of DM365 TRM
 *          .
 *  @param  None
 *
 *  @return None
...
void ARM926_INTC_init ()
{
    ...
    *(int *)ARM926_INTCTL = 0x0;  /* IDMODE=0, IERAW=0, FERAW=0             */
    ...
    /* Enable Interrupt No 10 KAL-HOST interrupt in EINT0                   */
    //*(int *)ARM926_EINT0 |= BIT_10_MASK; //DM365 changed
    *(int *)ARM926_EINT0 |= BIT_9_MASK; //DM365 changed

    /* Set up INTPRI : default value is 7: reset it to 7                    */
    *(int *)ARM926_INTPRI1 &= MJCP2HOST_INT_PRI_1;  //DM365 changed
