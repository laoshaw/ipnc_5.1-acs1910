...
#define AVSERVER_CMD_DMVA_EVENT (0x304)
#define AVSERVER_CMD_NEW_TZ_PARAM      (0x305)
#define AVSERVER_CMD_NEW_CTD_PARAM     (0x306)
#define AVSERVER_CMD_NEW_OC_PARAM      (0x307)
#define AVSERVER_CMD_NEW_MAIN_PARAM    (0x308)
#define AVSERVER_CMD_NEW_SMETA_PARAM    (0x309)
#define AVSERVER_CMD_NEW_IMD_PARAM     (0x30A)
#define AVSERVER_CMD_NEW_TZZONE1_PARAM (0x30B)
...
typedef struct {
  ...
  OSA_PrfHndl encryptPrf[4];
  OSA_PrfHndl decryptPrf[4];
