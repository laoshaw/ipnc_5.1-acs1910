...
#define SWOSD_WINDOW_TWELVE     11      	// DMVA's User String "EVALUATION" Window

/*ANR _ FR */
#define SWOSD_WINDOW_FR_ST     12      // revisit
...
#define VIDEO_RESOL_WIDTH_LARGE           	1500
#define VIDEO_RESOL_WIDTH_MEDIUM        	800
