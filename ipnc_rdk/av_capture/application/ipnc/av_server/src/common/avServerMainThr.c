...
int AVSERVER_tskStart(OSA_TskHndl *pTsk, OSA_MsgHndl *pMsg)
{
  ...
  if(gAVSERVER_config.deiTskEnable) {
    ...
    #ifdef AVSERVER_DEBUG_MAIN_THR
    OSA_printf(" AVSERVER MAIN: Create deiTsk ...\n");
    #endif

    status = OSA_tskSendMsg(&gVIDEO_ctrl.deiTsk, pTsk, AVSERVER_CMD_CREATE, NULL, OSA_MBX_WAIT_ACK);
  ...
  {
	  #ifdef AVSERVER_DEBUG_MAIN_THR
	  OSA_printf(" AVSERVER MAIN: Create dmvaTsk ...\n");
	  #endif

	  status = OSA_tskSendMsg(&gVIDEO_ctrl.dmvaTsk, pTsk, AVSERVER_CMD_CREATE, NULL, OSA_MBX_WAIT_ACK);
	  ...
	  #ifdef AVSERVER_DEBUG_MAIN_THR
	  OSA_printf(" AVSERVER MAIN: Create dmvaEvtTsk ...\n");
	  #endif

	  status = OSA_tskSendMsg(&gVIDEO_ctrl.dmvaEvtTsk, pTsk, AVSERVER_CMD_CREATE, NULL, OSA_MBX_WAIT_ACK);
...
int AVSERVER_tskStop(OSA_TskHndl *pTsk, OSA_MsgHndl *pMsg)
{
  ...
  if(gAVSERVER_config.deiTskEnable) {
   ...
   #ifdef AVSERVER_DEBUG_MAIN_THR
   OSA_printf(" AVSERVER MAIN: Delete deiTsk ...\n");
   #endif

    status |= OSA_tskSendMsg(&gVIDEO_ctrl.deiTsk, pTsk, AVSERVER_CMD_DELETE, NULL, OSA_MBX_WAIT_ACK);
  }
#endif
  ...
  {
	  #ifdef AVSERVER_DEBUG_MAIN_THR
	  OSA_printf(" AVSERVER MAIN: Delete dmvaEvtTsk ...\n");
	  #endif

	  status |= OSA_tskSendMsg(&gVIDEO_ctrl.dmvaEvtTsk, pTsk, AVSERVER_CMD_DELETE, NULL, OSA_MBX_WAIT_ACK);

	  #ifdef AVSERVER_DEBUG_MAIN_THR
	  OSA_printf(" AVSERVER MAIN: Delete dmvaTsk ...\n");
	  #endif

	  status |= OSA_tskSendMsg(&gVIDEO_ctrl.dmvaTsk, pTsk, AVSERVER_CMD_DELETE, NULL, OSA_MBX_WAIT_ACK);
  }
