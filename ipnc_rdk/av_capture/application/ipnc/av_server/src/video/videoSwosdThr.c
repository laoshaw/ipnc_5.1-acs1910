...
#define OSD_MEMCPY		memcpy 	//OSA_cmemCpy
...
char *strBuff1540_Y_DMVA[AVSERVER_MAX_STREAMS], *strBuff1540_UV_DMVA[AVSERVER_MAX_STREAMS];
char *strBuff1232_Y_DMVA[AVSERVER_MAX_STREAMS][MAX_STR_BUFF], *strBuff1232_UV_DMVA[AVSERVER_MAX_STREAMS][MAX_STR_BUFF];
char *strBuff1078_Y_DMVA[AVSERVER_MAX_STREAMS][MAX_STR_BUFF], *strBuff1078_UV_DMVA[AVSERVER_MAX_STREAMS][MAX_STR_BUFF];
char *strBuff462_Y_DMVA[AVSERVER_MAX_STREAMS][MAX_STR_BUFF], *strBuff462_UV_DMVA[AVSERVER_MAX_STREAMS][MAX_STR_BUFF];
...
#endif
		OSD_MEMCPY(iconBuff80_Y, TILogo_Y_80_32, SWOSD_CHARWIDTHTILOGO_80_32*SWOSD_CHARHEIGHTTILOGO_80_32);
		OSD_MEMCPY(iconBuff80_UV, TILogo_UV_80_32, (SWOSD_CHARWIDTHTILOGO_80_32*SWOSD_CHARHEIGHTTILOGO_80_32)/2);
	}
	else
	{
...
static int OSD_checkEvalVersion(int streamId)
{
	...
	if(gAVSERVER_config.captureConfig[streamId].vsEnable)
		...
		osdEvalFlag = 0;
#else
	if(gAVSERVER_config.faceDetectConfig.frRegUsr || gAVSERVER_config.faceDetectConfig.frIdentify)
		osdEvalFlag = 1;
	else if(gAVSERVER_config.aewb_config.saldreEnable)
		osdEvalFlag = 1;
	else
...
static int swosdChangeXYParmDetail(int streamId,SWOSD_Hndl *osdHndl )
{
	...
	SWOSD_setBmpchangeWinXYPrm(osdHndl, SWOSD_WINDOW_TWELVE, (width-(SWOSD_EVAL_STR_LEN*osdwidth)/2), (height*2-2*osdheight));
...
static int  swosdMakeWinString(int streamId)
{
	...
	if(gAVSERVER_config.encodeConfig[streamId].cropWidth<=VIDEO_RESOL_WIDTH_SMALL)
	{
		if((gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdLogoStringUpdate == OSD_YES) ||
	       (gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaStringUpdate == OSD_YES))
		{
			fontInfo.format		= SWOSD_FORMATYUV420p;
			fontInfo.charWidth		= SWOSD_CHARWIDTH_462_12;
			fontInfo.charHeight	= SWOSD_CHARHEIGHT_462_12;
			...
			SWOSD_MakeOsdwinstring(&fontInfo,  gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaDispString , strBuff462_Y_DMVA[streamId][7], &osdHndl->bmpWinPrm[SWOSD_WINDOW_TWELVE], strlen(gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaDispString));
			strBuff462_UV_DMVA[streamId][7]  = (char*)(osdHndl->bmpWinPrm[SWOSD_WINDOW_TWELVE].bmpWinAddrUV );
			SWOSD_setBmpWinAddr(osdHndl, strBuff462_Y_DMVA[streamId][7], strBuff462_UV_DMVA[streamId][7], SWOSD_WINDOW_TWELVE);

			gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdLogoStringUpdate = OSD_NO;
			gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaStringUpdate = OSD_NO;
		}
	...
	else if (gAVSERVER_config.encodeConfig[streamId].cropWidth<=VIDEO_RESOL_WIDTH_MEDIUM  )
	{
		   ...
		   (gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaStringUpdate == OSD_YES))
		{
			...
			SWOSD_MakeOsdwinstring(&fontInfo,  gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaDispString , strBuff1078_Y_DMVA[streamId][7], &osdHndl->bmpWinPrm[SWOSD_WINDOW_TWELVE], strlen(gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaDispString));
			strBuff1078_UV_DMVA[streamId][7]  = (char*)(osdHndl->bmpWinPrm[SWOSD_WINDOW_TWELVE].bmpWinAddrUV );
			SWOSD_setBmpWinAddr(osdHndl, strBuff1078_Y_DMVA[streamId][7], strBuff1078_UV_DMVA[streamId][7], SWOSD_WINDOW_TWELVE);
	...
	else if (gAVSERVER_config.encodeConfig[streamId].cropWidth<=VIDEO_RESOL_WIDTH_LARGE)
	{
		   ...
		   (gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaStringUpdate == OSD_YES))
		{
			...
			SWOSD_MakeOsdwinstring(&fontInfo,  gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaDispString , strBuff1232_Y_DMVA[streamId][7], &osdHndl->bmpWinPrm[SWOSD_WINDOW_TWELVE], strlen(gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaDispString));
			strBuff1232_UV_DMVA[streamId][7]  = (char*)(osdHndl->bmpWinPrm[SWOSD_WINDOW_TWELVE].bmpWinAddrUV );
			SWOSD_setBmpWinAddr(osdHndl, strBuff1232_Y_DMVA[streamId][7], strBuff1232_UV_DMVA[streamId][7], SWOSD_WINDOW_TWELVE);
	...
	else if(gAVSERVER_config.encodeConfig[streamId].cropWidth>= VIDEO_RESOL_WIDTH_LARGE)
	{
		   ...
		   (gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaStringUpdate == OSD_YES))
		{
			...
			SWOSD_MakeOsdwinstring(&fontInfo,  gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaDispString , strBuff1540_Y_DMVA[streamId], &osdHndl->bmpWinPrm[SWOSD_WINDOW_TWELVE], strlen(gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaDispString));
			strBuff1540_UV_DMVA[streamId]= (char*)(osdHndl->bmpWinPrm[SWOSD_WINDOW_TWELVE].bmpWinAddrUV );
			SWOSD_setBmpWinAddr(osdHndl, strBuff1540_Y_DMVA[streamId], strBuff1540_UV_DMVA[streamId], SWOSD_WINDOW_TWELVE);
...
static int swosdDisplay(int streamId, SWOSD_Hndl *osdHndl )
{
	...
	if(gAVSERVER_config.captureConfig[streamId].swosdConfig.swosdDmvaTextEnable)
		SWOSD_setBmpWinEnable(osdHndl, SWOSD_WINDOW_TWELVE, SWOSD_BMPWINENABLE);//TEXT
	else
		SWOSD_setBmpWinEnable(osdHndl, SWOSD_WINDOW_TWELVE, SWOSD_BMPWINDISABLE);//TEXT
...
int VIDEO_swosdTskRun(int streamId, OSA_BufInfo *pBufInfo)
{
	...
	OSD_MEMCPY((void*)pBufHeader,(void*)pBufInfo->virtAddr,sizeof(bufHeader));
...
int VIDEO_swosdTskCreate(void)
{
	...
	for(j=0; j<gAVSERVER_config.numCaptureStream; j++) {
		...
		strBuff1540_Y_DMVA[j] = (char*)OSD_CMEM_ALLOC((SWOSD_MAX_STRING_LENGTH*SWOSD_CHARWIDTH_1540_40*SWOSD_CHARHEIGHT_1540_40*3)/2,  32);
		for(i=0; i<MAX_STR_BUFF; i++)
		{
			...
			strBuff1232_Y_DMVA[j][i] = (char*)OSD_CMEM_ALLOC((SWOSD_MAX_STRING_LENGTH*SWOSD_CHARWIDTH_1232_30*SWOSD_CHARHEIGHT_1232_30*3)/2,  32);
			strBuff1078_Y_DMVA[j][i] = (char*)OSD_CMEM_ALLOC((SWOSD_MAX_STRING_LENGTH*SWOSD_CHARWIDTH_1078_28*SWOSD_CHARHEIGHT_1078_28*3)/2,  32);
			strBuff462_Y_DMVA[j][i] = (char*)OSD_CMEM_ALLOC((SWOSD_MAX_STRING_LENGTH*SWOSD_CHARWIDTH_462_12*SWOSD_CHARHEIGHT_462_12*3)/2,  32);
		}
	}
	...
	OSD_MEMCPY(fontBuff1540_Y1, YData_1540_40_WFONT, SWOSD_STRINGWIDTH_1540_40*SWOSD_CHARHEIGHT_1540_40);
	fontBuff1540_UV1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1540_40*(SWOSD_CHARHEIGHT_1540_40/2)) ,32);
	OSD_MEMCPY(fontBuff1540_UV1, UVData_1540_40_WFONT, SWOSD_STRINGWIDTH_1540_40*(SWOSD_CHARHEIGHT_1540_40/2));

	fontBuff1232_Y= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1232_30*SWOSD_CHARHEIGHT_1232_30) , 32);
	OSD_MEMCPY(fontBuff1232_Y, YData_1232_30, SWOSD_STRINGWIDTH_1232_30*SWOSD_CHARHEIGHT_1232_30);
	fontBuff1232_UV= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1232_30*(SWOSD_CHARHEIGHT_1232_30/2)) ,32);
	OSD_MEMCPY(fontBuff1232_UV, UVData_1232_30, SWOSD_STRINGWIDTH_1232_30*(SWOSD_CHARHEIGHT_1232_30/2));

	fontBuff1232_Y1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1232_30*SWOSD_CHARHEIGHT_1232_30) , 32);
	OSD_MEMCPY(fontBuff1232_Y1, YData_1232_30_WFONT, SWOSD_STRINGWIDTH_1232_30*SWOSD_CHARHEIGHT_1232_30);
	fontBuff1232_UV1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1232_30*(SWOSD_CHARHEIGHT_1232_30/2)) ,32);
	OSD_MEMCPY(fontBuff1232_UV1, UVData_1232_30_WFONT, SWOSD_STRINGWIDTH_1232_30*(SWOSD_CHARHEIGHT_1232_30/2));

	fontBuff1078_Y= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1078_28*SWOSD_CHARHEIGHT_1078_28) , 32);
	OSD_MEMCPY(fontBuff1078_Y, YData_1078_28, SWOSD_STRINGWIDTH_1078_28*SWOSD_CHARHEIGHT_1078_28);
	fontBuff1078_UV= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1078_28*(SWOSD_CHARHEIGHT_1078_28/2)) ,32);
	OSD_MEMCPY(fontBuff1078_UV, UVData_1078_28, SWOSD_STRINGWIDTH_1078_28*(SWOSD_CHARHEIGHT_1078_28/2));

	fontBuff1078_Y1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1078_28*SWOSD_CHARHEIGHT_1078_28) , 32);
	OSD_MEMCPY(fontBuff1078_Y1, YData_1078_28_WFONT, SWOSD_STRINGWIDTH_1078_28*SWOSD_CHARHEIGHT_1078_28);
	fontBuff1078_UV1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1078_28*(SWOSD_CHARHEIGHT_1078_28/2)) ,32);
	OSD_MEMCPY(fontBuff1078_UV1, UVData_1078_28_WFONT, SWOSD_STRINGWIDTH_1078_28*(SWOSD_CHARHEIGHT_1078_28/2));

	fontBuff770_Y= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_770_20*SWOSD_CHARHEIGHT_770_20) , 32);
	OSD_MEMCPY(fontBuff770_Y, YData_770_20, SWOSD_STRINGWIDTH_770_20*SWOSD_CHARHEIGHT_770_20);
	fontBuff770_UV= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_770_20*(SWOSD_CHARHEIGHT_770_20/2)) ,32);
	OSD_MEMCPY(fontBuff770_UV, UVData_770_20, SWOSD_STRINGWIDTH_770_20*(SWOSD_CHARHEIGHT_770_20/2));

	fontBuff770_Y1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_770_20*SWOSD_CHARHEIGHT_770_20) , 32);
	OSD_MEMCPY(fontBuff770_Y1, YData_770_20_WFONT, SWOSD_STRINGWIDTH_770_20*SWOSD_CHARHEIGHT_770_20);
	fontBuff770_UV1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_770_20*(SWOSD_CHARHEIGHT_770_20/2)) ,32);
	OSD_MEMCPY(fontBuff770_UV1, UVData_770_20_WFONT, SWOSD_STRINGWIDTH_770_20*(SWOSD_CHARHEIGHT_770_20/2));

	fontBuff462_Y= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_462_12*SWOSD_CHARHEIGHT_462_12) , 32);
	OSD_MEMCPY(fontBuff462_Y, YData_462_12, SWOSD_STRINGWIDTH_462_12*SWOSD_CHARHEIGHT_462_12);
	fontBuff462_UV= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_462_12*(SWOSD_CHARHEIGHT_462_12/2)) ,32);
	OSD_MEMCPY(fontBuff462_UV, UVData_462_12, SWOSD_STRINGWIDTH_462_12*(SWOSD_CHARHEIGHT_462_12/2));

	fontBuff462_Y1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_462_12*SWOSD_CHARHEIGHT_462_12) , 32);
	OSD_MEMCPY(fontBuff462_Y1, YData_462_12_WFONT, SWOSD_STRINGWIDTH_462_12*SWOSD_CHARHEIGHT_462_12);
	fontBuff462_UV1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_462_12*(SWOSD_CHARHEIGHT_462_12/2)) ,32);
	OSD_MEMCPY(fontBuff462_UV1, UVData_462_12_WFONT, SWOSD_STRINGWIDTH_462_12*(SWOSD_CHARHEIGHT_462_12/2));
#else

	fontBuff1540_Y1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1540_40*SWOSD_CHARHEIGHT_1540_40) , 32);
	OSD_MEMCPY(fontBuff1540_Y1, YData_1540_40_WFONT_PURE, SWOSD_STRINGWIDTH_1540_40*SWOSD_CHARHEIGHT_1540_40);
	fontBuff1540_UV1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1540_40*(SWOSD_CHARHEIGHT_1540_40/2)) ,32);
	OSD_MEMCPY(fontBuff1540_UV1, UVData_1540_40_WFONT_PURE, SWOSD_STRINGWIDTH_1540_40*(SWOSD_CHARHEIGHT_1540_40/2));

	fontBuff1232_Y1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1232_30*SWOSD_CHARHEIGHT_1232_30) , 32);
	OSD_MEMCPY(fontBuff1232_Y1, YData_1232_30_WFONT_PURE, SWOSD_STRINGWIDTH_1232_30*SWOSD_CHARHEIGHT_1232_30);
	fontBuff1232_UV1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1232_30*(SWOSD_CHARHEIGHT_1232_30/2)) ,32);
	OSD_MEMCPY(fontBuff1232_UV1, UVData_1232_30_WFONT_PURE, SWOSD_STRINGWIDTH_1232_30*(SWOSD_CHARHEIGHT_1232_30/2));

	fontBuff1078_Y1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1078_28*SWOSD_CHARHEIGHT_1078_28) , 32);
	OSD_MEMCPY(fontBuff1078_Y1, YData_1078_28_WFONT_PURE, SWOSD_STRINGWIDTH_1078_28*SWOSD_CHARHEIGHT_1078_28);
	fontBuff1078_UV1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_1078_28*(SWOSD_CHARHEIGHT_1078_28/2)) ,32);
	OSD_MEMCPY(fontBuff1078_UV1, UVData_1078_28_WFONT_PURE, SWOSD_STRINGWIDTH_1078_28*(SWOSD_CHARHEIGHT_1078_28/2));

	fontBuff770_Y1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_770_20*SWOSD_CHARHEIGHT_770_20) , 32);
	OSD_MEMCPY(fontBuff770_Y1, YData_770_20_WFONT_PURE, SWOSD_STRINGWIDTH_770_20*SWOSD_CHARHEIGHT_770_20);
	fontBuff770_UV1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_770_20*(SWOSD_CHARHEIGHT_770_20/2)) ,32);
	OSD_MEMCPY(fontBuff770_UV1, UVData_770_20_WFONT_PURE, SWOSD_STRINGWIDTH_770_20*(SWOSD_CHARHEIGHT_770_20/2));

	fontBuff462_Y1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_462_12*SWOSD_CHARHEIGHT_462_12) , 32);
	OSD_MEMCPY(fontBuff462_Y1, YData_462_12_WFONT_PURE, SWOSD_STRINGWIDTH_462_12*SWOSD_CHARHEIGHT_462_12);
	fontBuff462_UV1= (char *)OSD_CMEM_ALLOC((SWOSD_STRINGWIDTH_462_12*(SWOSD_CHARHEIGHT_462_12/2)) ,32);
	OSD_MEMCPY(fontBuff462_UV1, UVData_462_12_WFONT_PURE, SWOSD_STRINGWIDTH_462_12*(SWOSD_CHARHEIGHT_462_12/2));
#endif
...
int VIDEO_swosdTskDelete(void)
{
	...
	for(j=0; j<gAVSERVER_config.numCaptureStream; j++) {
		...
		if(strBuff1540_Y_DMVA[j] != NULL)
		{
			OSA_cmemFree((Uint8*)strBuff1540_Y_DMVA[j]);
			strBuff1540_Y_DMVA[j] = NULL;
		}
		for(i = 0; i<MAX_STR_BUFF; i++)
		{
			...
			if(strBuff1232_Y_DMVA[j][i] != NULL)
			{
				OSA_cmemFree((Uint8*)strBuff1232_Y_DMVA[j][i]);
				strBuff1232_Y_DMVA[j][i] = NULL;
			}

			if(strBuff1078_Y_DMVA[j][i] != NULL)
			{
				OSA_cmemFree((Uint8*)strBuff1078_Y_DMVA[j][i]);
				strBuff1078_Y_DMVA[j][i] = NULL;
			}

			if(strBuff462_Y_DMVA[j][i] != NULL)
			{
				OSA_cmemFree((Uint8*)strBuff462_Y_DMVA[j][i]);
				strBuff462_Y_DMVA[j][i]= NULL;
			}
		}
	}
