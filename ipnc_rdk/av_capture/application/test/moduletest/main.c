...
int ALG_tzImgSymTestMain(int argc, char **argv);
int ALG_nmsTestMain(int argc, char **argv);
int ALG_dmvalTestMain(int argc, char **argv);
...
int main(int argc, char **argv)
{
  ...
  if(strcmp(argv[1], "alg_isf")==0)
    status = ALG_tzImgSymTestMain(argc, argv);
  else
  if(strcmp(argv[1], "alg_nms")==0)
    status = ALG_nmsTestMain(argc, argv);
  else
  if(strcmp(argv[1], "alg_morp")==0)
    status = ALG_morpTestMain(argc, argv);
  else
  if(strcmp(argv[1], "alg_dmval")==0)
    status = ALG_dmvalTestMain(argc, argv);
