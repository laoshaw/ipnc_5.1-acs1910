...
int IMAGE_TUNE_Init()
{
  ...
  IMAGE_TUNE_AttachCmdHandler(IMAGE_TUNE_TNF3_PRM,   IMAGE_TUNE_CmdExecuteTnf3Prm );
...
int IMAGE_TUNE_GetParams(IMAGE_TUNE_Params *prm)
{
  ...
  if(prm->pTnf3Prm!=NULL)
    memcpy(prm->pTnf3Prm, &gIMAGE_TUNE_ctrl.curPrm.tnf3Prm, sizeof(gIMAGE_TUNE_ctrl.curPrm.tnf3Prm));
...
//#endif   //For testing
    ...
    memcpy(&pPrmList->paramSet[pID].tnf3Prm, &prm->tnf3Prm, sizeof(prm->tnf3Prm));
...
int IMAGE_TUNE_LoadParams(int paramSetId)
{
  ...
  if(gImageTunePrmList != NULL) {
    ...
    memcpy(&gIMAGE_TUNE_ctrl.curPrm.tnf3Prm, &pPrmList->paramSet[pID].tnf3Prm, sizeof(ALG_tnf3Params));
...
{
	memcpy(tnf3Params, &gIMAGE_TUNE_ctrl.curPrm.tnf3Prm, sizeof(*tnf3Params));
	return OSA_SOK;
}

int IMAGE_TUNE_SetTnf3Params(ALG_tnf3Params *tnf3Params)
{
	memcpy(&gIMAGE_TUNE_ctrl.curPrm.tnf3Prm, tnf3Params, sizeof(*tnf3Params));
	return OSA_SOK;
}
