...
Uint16 gYuvModeWidth  = 720;
Uint16 gYuvModeHeight = 480;
...
//add pamsimochen
    case DRV_IMGS_SENSOR_MODE_1280x800:
      ...
      *height = 800;
      break;
    case DRV_IMGS_SENSOR_MODE_ACS1910:
        *width = DRV_IMGS_WIDTH_ACS1910;
        *height = DRV_IMGS_HEIGHT_ACS1910;
        break;
//end add
    }
