...
int I2C_detectClient(struct i2c_adapter *adapter, int address)
{
    ...
    struct i2c_board_info info[] = {
	{
		...
		I2C_BOARD_INFO("mt9p031-tvp514x", 0x5d),
	#else
...
void *I2C_create(int devAddr) {
    ...
    driver->detach_adapter= I2C_detachClient;
...
int I2C_devIoctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
  I2C_Obj *pObj;
  int status=0;
