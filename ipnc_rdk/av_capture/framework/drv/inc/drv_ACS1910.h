...
#define FPGA_ROI_1_REG_BASE (123)
#define FPGA_ROI_1_X_REG_OFFSET (0)
#define FPGA_ROI_1_Y_REG_OFFSET (1)
#define FPGA_ROI_1_WIDTH_REG_OFFSET (2)
#define FPGA_ROI_1_HEIGHT_REG_OFFSET (3)
#define FPGA_ROI_1_X_REG_ADDR (FPGA_ROI_1_REG_BASE + FPGA_ROI_1_X_REG_OFFSET)
#define FPGA_ROI_1_Y_REG_ADDR (FPGA_ROI_1_REG_BASE + FPGA_ROI_1_Y_REG_OFFSET)
#define FPGA_ROI_1_WIDTH_REG_ADDR (FPGA_ROI_1_REG_BASE + FPGA_ROI_1_WIDTH_REG_OFFSET)
#define FPGA_ROI_1_HEIGHT_REG_ADDR (FPGA_ROI_1_REG_BASE + FPGA_ROI_1_HEIGHT_REG_OFFSET)

#define FPGA_ROI_2_REG_BASE (123)
#define FPGA_ROI_2_X_REG_OFFSET (0)
#define FPGA_ROI_2_Y_REG_OFFSET (1)
#define FPGA_ROI_2_WIDTH_REG_OFFSET (2)
#define FPGA_ROI_2_HEIGHT_REG_OFFSET (3)
#define FPGA_ROI_2_X_REG_ADDR (FPGA_ROI_2_REG_BASE + FPGA_ROI_2_X_REG_OFFSET)
#define FPGA_ROI_2_Y_REG_ADDR (FPGA_ROI_2_REG_BASE + FPGA_ROI_2_Y_REG_OFFSET)
#define FPGA_ROI_2_WIDTH_REG_ADDR (FPGA_ROI_2_REG_BASE + FPGA_ROI_2_WIDTH_REG_OFFSET)
#define FPGA_ROI_2_HEIGHT_REG_ADDR (FPGA_ROI_2_REG_BASE + FPGA_ROI_2_HEIGHT_REG_OFFSET)

#define FPGA_ROI_3_REG_BASE (123)
#define FPGA_ROI_3_X_REG_OFFSET (0)
#define FPGA_ROI_3_Y_REG_OFFSET (1)
#define FPGA_ROI_3_WIDTH_REG_OFFSET (2)
#define FPGA_ROI_3_HEIGHT_REG_OFFSET (3)
#define FPGA_ROI_3_X_REG_ADDR (FPGA_ROI_3_REG_BASE + FPGA_ROI_3_X_REG_OFFSET)
#define FPGA_ROI_3_Y_REG_ADDR (FPGA_ROI_3_REG_BASE + FPGA_ROI_3_Y_REG_OFFSET)
#define FPGA_ROI_3_WIDTH_REG_ADDR (FPGA_ROI_3_REG_BASE + FPGA_ROI_3_WIDTH_REG_OFFSET)
#define FPGA_ROI_3_HEIGHT_REG_ADDR (FPGA_ROI_3_REG_BASE + FPGA_ROI_3_HEIGHT_REG_OFFSET)
...
#define ROI_NO 3
#define DEFAULT_ROI_1 {1, DEFAULT_ROI_OFF, DEFAULT_ROI1_X, DEFAULT_ROI1_Y, DEFAULT_ROI1_WIDTH, DEFAULT_ROI1_HEIGHT}
#define DEFAULT_ROI_2 {2, DEFAULT_ROI_OFF, DEFAULT_ROI2_X, DEFAULT_ROI2_Y, DEFAULT_ROI2_WIDTH, DEFAULT_ROI2_HEIGHT}
#define DEFAULT_ROI_3 {3, DEFAULT_ROI_OFF, DEFAULT_ROI3_X, DEFAULT_ROI3_Y, DEFAULT_ROI3_WIDTH, DEFAULT_ROI3_HEIGHT}
