...
Int32 SALDRE_create(Uint16 width, Uint16 height, Uint16 temporalAverWinSize);
...
void getTheSmartGLBCEStrengths(unsigned int gGlbceMode, char isSystemStabilized, int sensorGain,
			short WB_RGain, short WB_GrGain, short WB_GbGain, short WB_BGain,
			unsigned int *GBEStrength, unsigned int *GCEStrength, unsigned int *LBEStrength, unsigned int *LCEStrength);
