...
const char *dayfrmrate_list1_dm368[MAX_FRAMERATE_SIZE] =
{
	...
	"30,24,15,8;30,24,15,8;30,24,15,8;30,24,15,8;30,24,15,8",
	"30,24,15,8;30,24,15,8;30,24,15,8;30,24,15,8;30,24,15,8",
	"30,24,15,8;30,24,15,8;30,24,15,8;30,24,15,8;30,24,15,8",
	"30,24,15,8;30,24,15,8;30,24,15,8;30,24,15,8;30,24,15,8",
...
const char *nightfrmrate_list1_dm368[MAX_FRAMERATE_SIZE] =
{
	...
	"30,15,5;30,15,5;30,15,5;30,15,5;30,15,5",
	"30,15,5;30,15,5;30,15,5;30,15,5;30,15,5",
	"30,15,5;30,15,5;30,15,5;30,15,5;30,15,5",
	"30,15,5;30,15,5;30,15,5;30,15,5;30,15,5",
	"30,15,5;30,15,5",
...
{
	"30,24,15,8;30,24,15,8;30,24,15,8;24,15,8;Auto",
	"30,24,15,8;30,24,15,8;30,24,15,8;24,15,8;Auto",
	"30,24,15,8;30,24,15,8;15,8;15,8;Auto;Auto",
	"30,24,15,8;30,24,15,8;30,24,15,8;24,15,8;24,15,8",
	"30,24,15,8;30,24,15,8;30,24,15,8;24,15,8;24,15,8",
	"30,24,15,8;30,24,15,8;30,24,15,8;24,15,8;24,15,8",
	"30,24,15,8;30,24,15,8;30,24,15,8;24,15,8;24,15,8",
	"30,24,15,8;24,15,8",
...
{
	"30,15,5;30,15,5;30,15,5;24,15,5;Auto",
	"30,15,5;30,15,5;30,15,5;24,15,5;Auto",
	"30,24,15,5;30,24,15,5;15,5;15,5;Auto;Auto",
	"30,15,5;30,15,5;30,15,5;24,15,5;24,15,5",
	"30,15,5;30,15,5;30,15,5;24,15,5;24,15,5",
	"30,15,5;30,15,5;30,15,5;24,15,5;24,15,5",
	"30,15,5;30,15,5;30,15,5;24,15,5;24,15,5",
	"30,15,5;24,15,5",
...
int para_frameratenameall1(char *data, char *arg)
{
	...
	int tblsize;
	char rtn_msg[1024] = "\0";
	const char **nightfrmrate_list1 = ((pSysInfo->lan_config.chipConfig == CHIP_DM365) || (pSysInfo->lan_config.chipConfig == CHIP_DMVA1)) ? nightfrmrate_list1_dm365:nightfrmrate_list1_dm368;
	const char **dayfrmrate_list1 = ((pSysInfo->lan_config.chipConfig == CHIP_DM365) || (pSysInfo->lan_config.chipConfig == CHIP_DMVA1)) ? dayfrmrate_list1_dm365:dayfrmrate_list1_dm368;
...
int para_frameratenameall2(char *data, char *arg)
{
	...
	int tblsize;
	char rtn_msg[1024] = "\0";
	const char **nightfrmrate_list2 = ((pSysInfo->lan_config.chipConfig == CHIP_DM365) || (pSysInfo->lan_config.chipConfig == CHIP_DMVA1)) ? nightfrmrate_list2_dm365:nightfrmrate_list2_dm368;
	const char **dayfrmrate_list2 = ((pSysInfo->lan_config.chipConfig == CHIP_DM365) || (pSysInfo->lan_config.chipConfig == CHIP_DMVA1)) ? dayfrmrate_list2_dm365:dayfrmrate_list2_dm368;
...
int para_frameratenameall3(char *data, char *arg)
{
	...
	int tblsize;
	char rtn_msg[1024] = "\0";
	const char **nightfrmrate_list3 = ((pSysInfo->lan_config.chipConfig == CHIP_DM365) || (pSysInfo->lan_config.chipConfig == CHIP_DMVA1)) ? nightfrmrate_list3_dm365:nightfrmrate_list3_dm368;
	const char **dayfrmrate_list3 = ((pSysInfo->lan_config.chipConfig == CHIP_DM365) || (pSysInfo->lan_config.chipConfig == CHIP_DMVA1)) ? dayfrmrate_list3_dm365:dayfrmrate_list3_dm368;
...
int para_dynrangename(char *data, char *arg)
{
    ...
    if ( *arg == '0' )
		...
		return sprintf(data, "Global");
	else if ( *arg == '2' )
		return sprintf(data, "Local");
	else if ( *arg == '3' )
		return sprintf(data, "Adaptive");
	else if ( *arg == 'a' || *arg == '\0' )
		return sprintf(data, "None;Global;Local;Adaptive");
   ...
   int para_dynrangestrengthname(char *data, char *arg)
 {
 	if ( *arg == '0' )
 		...
 		return sprintf(data, "MED");
 	else if ( *arg == '2' )
 		return sprintf(data, "HIGH");
 	else if ( *arg == 'a' || *arg == '\0' )
 		return sprintf(data, "LOW;MED;HIGH");
...
int para_ldc(char *data, char *arg)
    ...
    int para_vnfmodename(char *data, char *arg)
 {
	if ( *arg == '0' )
 		...
 		return sprintf(data, "TNF;SNF;SNF+TNF");
...
int para_biosversion(char *data, char *arg)
{
	...
	switch(pSysInfo->lan_config.chipConfig)
	{
		case CHIP_DM365:
		case CHIP_DMVA1:
...
int para_softwareversion(char *data, char *arg)
{
	...
	switch(pSysInfo->lan_config.chipConfig)
	{
		...
		case CHIP_DM368E:
			...
			break;
		case CHIP_DM369:
			return sprintf(data, "%s", DM369_APP_VERSION);
			break;
		case CHIP_DMVA1:
			return sprintf(data, "%s", DMVA1_APP_VERSION);
			break;
		case CHIP_DMVA2:
			return sprintf(data, "%s", DMVA2_APP_VERSION);
			break;
	}
}
...
{
	return sprintf(data, "%d", GUI_RELOAD_TIME_IN_SECS);
}
 ...
 int para_flickerdetectname(char *data, char *arg)
{
	if ( *arg == '0' )
		...
		return sprintf(data, "None;Unknown;50Hz;60Hz");
