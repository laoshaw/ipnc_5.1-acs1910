...
void process_requests(int server_s,int server_udp,struct soap*);
#ifdef UDP_HEADER
void process_requests(int server_s,int server_udp,struct soap*,struct soap*);
void process_requests_udp(struct soap*);
#endif
...
int bind_server_udp(int server_s, char *ip);
char *ascii_sockaddr(struct SOCKADDR *s, char *dest, int len);
int net_port(struct SOCKADDR *s);

/* select */
void select_loop(int server_s,int server_udp,struct soap*);
#ifdef UDP_HEADER
void select_loop(int server_s,int server_udp,struct soap*,struct soap*);
#endif
#endif
