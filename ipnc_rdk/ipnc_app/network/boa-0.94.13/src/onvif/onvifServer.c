...
SOAP_SOURCE_STAMP("@(#) onvifServer.c ver 2.8.0 2011-03-31 10:10:08 GMT")
...
int udp_hello(int *server_udp)
{
	...
	while(1)
	{
		...
		while(itr < NUM_BROADCAST)
		{
			...
			if (soap_send___ns1__sendHello(soaph, NULL, NULL, NULL))
			{
...
void ByeHandler(int sig)
{
	...
	soap_default_SOAP_ENV__Header(&soapb, &header);                      /* setting default values for header */
	soapb->header = &header;
	net_get_hwaddr(ETH_NAME, macaddr);
	time_n = time(NULL);
	tm_t=localtime(&time_n);
	...
	sleep(1);
	if (soap_send___ns1__sendBye(soapb,NULL,NULL,NULL))
	{
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve(struct soap *soap)
{
	...
	do
	{
		...
		if (soap_envelope_begin_in(soap)
		 ...
		 || soap_serve_request(soap,NULL,SERVICE_ONVIF)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_request(struct soap *soap, char *service_uri, int lookupindex)
{
	soap_peek_element(soap);

	if(lookupindex == SERVICE_DEVICE || lookupindex == SERVICE_ONVIF)
	{
	...
	if(lookupindex == SERVICE_IMAGING || lookupindex == SERVICE_ONVIF)
      	{
	...
	if(lookupindex == SERVICE_MEDIA || lookupindex == SERVICE_ONVIF)
      	{
	...
	if(lookupindex == SERVICE_ONVIF)
	{
		if (!soap_match_tag(soap, soap->tag, "ns1:Hello"))
			return soap_serve___ns2__Hello(soap);
		if (!soap_match_tag(soap, soap->tag, "ns1:Bye"))
			return soap_serve___ns2__Bye(soap);
		if (!soap_match_tag(soap, soap->tag, "d:Probe"))
			return soap_serve___ns3__Probe(soap);
		...
		/* Events */              
                if (!soap_match_tag(soap, soap->tag, "tet:PullMessages"))
                        return soap_serve___ns8__PullMessages(soap);
                if (!soap_match_tag(soap, soap->tag, "tet:SetSynchronizationPoint"))
                        return soap_serve___ns8__SetSynchronizationPoint(soap);
                if (!soap_match_tag(soap, soap->tag, "tet:CreatePullPointSubscription"))
		{
		        return soap_serve___ns9__CreatePullPointSubscription(soap);
		}
                if (!soap_match_tag(soap, soap->tag, "tet:GetEventProperties"))
		{
                        return soap_serve___ns9__GetEventProperties(soap);
		}
          	/* Event Renew */
		if (!soap_match_tag(soap, soap->tag, "ns6:Renew"))
	                return soap_serve___ns10__Renew(soap);
	        if (!soap_match_tag(soap, soap->tag, "ns6:Notify"))
        	        return soap_serve___ns12__Notify(soap);
		if (!soap_match_tag(soap, soap->tag, "ns6:Unsubscribe"))
	                return soap_serve___ns10__Unsubscribe(soap);
		if (!soap_match_tag(soap, soap->tag, "Subscribe"))
	                return soap_serve___ns11__Subscribe(soap);
  	} 
...
/**
* @brief Hello
* @This operation sends the hello message contains device basic information when camera boots up.
*
* @param                : __ns2__Hello structure contains the device information.

*/

SOAP_FMAC5 int SOAP_FMAC6 soap_send___ns1__sendHello(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct __ns2__Hello *ns2__Hello)
{
	...
	ns2__Hello = (struct __ns2__Hello*)soap_malloc(soap, sizeof(struct __ns2__Hello));
	ns2__Hello->ns1__Hello = (struct d__HelloType*)soap_malloc(soap, sizeof(struct d__HelloType));

	net_get_hwaddr(ETH_NAME, macaddr);
	_ip.int32 = net_get_ifaddr(ETH_NAME);
	sprintf(ip, "%03d.%03d.%03d.%03d",_ip.str[0], _ip.str[1], _ip.str[2], _ip.str[3]);
	sprintf(_IPAddr, "http://169.254.166.174/onvif/services http://%s/onvif/services", ip);
	...
	ns2__Hello->ns1__Hello->wsa__EndpointReference.Address = _HwId;
	ns2__Hello->ns1__Hello->wsa__EndpointReference.PortType = NULL;
	ns2__Hello->ns1__Hello->wsa__EndpointReference.ServiceName = NULL;
	ns2__Hello->ns1__Hello->wsa__EndpointReference.ReferenceProperties = NULL;
	ns2__Hello->ns1__Hello->wsa__EndpointReference.ReferenceParameters = NULL;
	ns2__Hello->ns1__Hello->wsa__EndpointReference.__any = NULL;
	ns2__Hello->ns1__Hello->Scopes = (struct d__ScopesType*)soap_malloc(soap, sizeof(struct d__ScopesType));
        ns2__Hello->ns1__Hello->Scopes->__item = (char*)soap_malloc(soap, sizeof(char)*LARGE_INFO_LENGTH);
	memset(ns2__Hello->ns1__Hello->Scopes->__item,0,sizeof(ns2__Hello->ns1__Hello->Scopes->__item));
        while(strstr(oSysInfo->onvif_scopes.type[i], DEFAULT_SCOPE) != NULL)
        {
		strcat(ns2__Hello->ns1__Hello->Scopes->__item,oSysInfo->onvif_scopes.type[i]);
		strcat(ns2__Hello->ns1__Hello->Scopes->__item," ");
		i++;
        }
        i = 0;
	strcat(ns2__Hello->ns1__Hello->Scopes->__item, oSysInfo->onvif_scopes.name);
	strcat(ns2__Hello->ns1__Hello->Scopes->__item, " ");
	strcat(ns2__Hello->ns1__Hello->Scopes->__item, oSysInfo->onvif_scopes.hardware);
	strcat(ns2__Hello->ns1__Hello->Scopes->__item, " ");
        while(strstr(oSysInfo->onvif_scopes.location[i], DEFAULT_SCOPE) != NULL)
        {
		strcat(ns2__Hello->ns1__Hello->Scopes->__item, oSysInfo->onvif_scopes.location[i]);
		strcat(ns2__Hello->ns1__Hello->Scopes->__item, " ");
		i++;
        }
	ns2__Hello->ns1__Hello->Scopes->MatchBy = NULL;
	ns2__Hello->ns1__Hello->XAddrs=_IPAddr;// http://169.254.166.174/onvif/services";
	ns2__Hello->ns1__Hello->Types = "dn:NetworkVideoTransmitter";
	ns2__Hello->ns1__Hello->MetadataVersion = 1;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns2__Hello(soap, ns2__Hello);
	...
	if (soap->mode & SOAP_IO_LENGTH)
	{
		if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns2__Hello(soap, ns2__Hello, "-d:Hello", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
		{
			 return soap->error;
...
/**
* @brief Bye
* @This operation sends the Bye Message when camera leaves the network.
*
* @param                : __ns2__Bye  structure contains the device information.

*/

SOAP_FMAC5 int SOAP_FMAC6 soap_send___ns1__sendBye(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct __ns2__Bye *ns2__Bye)
{
	char _IPAddr[INFO_LENGTH];
	char macaddr[MACH_ADDR_LENGTH];
	char ip[IP_LENGTH];
	...
	soap->encodingStyle = NULL;
        ...
        ns2__Bye  = (struct __ns2__Bye*)soap_malloc(soap, sizeof(struct __ns2__Bye));
        soap_default___ns2__Bye(soap,ns2__Bye);
        ns2__Bye->ns1__Bye  = (struct d__ByeType*)soap_malloc(soap, sizeof(struct d__ByeType));
	ns2__Bye->ns1__Bye->wsa__EndpointReference.Address =(char*)soap_malloc(soap, sizeof(char) * LARGE_INFO_LENGTH);

	net_get_hwaddr(ETH_NAME, macaddr);
	_ip.int32 = net_get_ifaddr(ETH_NAME);
	sprintf(ip, "%03d.%03d.%03d.%03d",_ip.str[0], _ip.str[1], _ip.str[2], _ip.str[3]);
	sprintf(_IPAddr, "http://169.254.166.174/onvif/services http://%s/onvif/device_service", ip);
	sprintf(_HwId,"urn:uuid:1419d68a-1dd2-11b2-a105-%02X%02X%02X%02X%02X%02X",macaddr[0], macaddr[1], macaddr[2], macaddr[3], macaddr[4], macaddr[5]);
	ns2__Bye->ns1__Bye->wsa__EndpointReference.Address = (char *)soap_malloc(soap, sizeof(char) * LARGE_INFO_LENGTH);
	strcpy(ns2__Bye->ns1__Bye->wsa__EndpointReference.Address, _HwId);
        ns2__Bye->ns1__Bye->wsa__EndpointReference.PortType = (char **)soap_malloc(soap, sizeof(char *));
	ns2__Bye->ns1__Bye->wsa__EndpointReference.PortType[0]= (char *)soap_malloc(soap, sizeof(char) * SMALL_INFO_LENGTH);
	strcpy(ns2__Bye->ns1__Bye->wsa__EndpointReference.PortType[0], "ttl");
	ns2__Bye->ns1__Bye->wsa__EndpointReference.ServiceName=NULL;
	ns2__Bye->ns1__Bye->wsa__EndpointReference.ReferenceProperties=NULL;
	ns2__Bye->ns1__Bye->wsa__EndpointReference.ReferenceParameters=NULL;
        ns2__Bye->ns1__Bye->wsa__EndpointReference.__size = 0;
        ns2__Bye->ns1__Bye->wsa__EndpointReference.__any = (char **)soap_malloc(soap, sizeof(char *));
	ns2__Bye->ns1__Bye->wsa__EndpointReference.__any[0] = (char *)soap_malloc(soap, sizeof(char) * SMALL_INFO_LENGTH);
	strcpy(ns2__Bye->ns1__Bye->wsa__EndpointReference.__any[0], "any");
        ns2__Bye->ns1__Bye->wsa__EndpointReference.__anyAttribute = NULL; 
        ns2__Bye->ns1__Bye->Scopes = (struct d__ScopesType*)malloc(sizeof(struct d__ScopesType));
        ns2__Bye->ns1__Bye->Scopes->__item="onvif://www.onvif.org/type/video_encoder onvif://www.onvif.org/type/audio_encoder onvif://www.onvif.org/Hardware/DM365_IPNC onvif://www.onvif.org/name/Dhruv%20DM365_IPNC onvif://www.onvif.org/location/" ;
        ns2__Bye->ns1__Bye->Scopes->MatchBy = NULL;
        ns2__Bye->ns1__Bye->XAddrs= (char *) soap_malloc(soap, sizeof(char) * INFO_LENGTH);// http://169.254.166.174/onvif/services";
        strcpy(ns2__Bye->ns1__Bye->XAddrs, _IPAddr);// http://169.254.166.174/onvif/services";
        ns2__Bye->ns1__Bye->Types = "dn:NetworkVideoTransmitter";
        ns2__Bye->ns1__Bye->MetadataVersion = NULL;
	soap_begin(soap);
	soap_serializeheader(soap);
	soap_serialize___ns2__Bye(soap,ns2__Bye);
	if (soap_begin_count(soap))
	{
		return soap->error;
	}
	if (soap->mode & SOAP_IO_LENGTH)
	{
		if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns2__Bye(soap, ns2__Bye, "d:Bye", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
		{
			 return soap->error;
	...
	|| soap_putheader(soap)
	|| soap_body_begin_out(soap)
        || soap_put___ns2__Bye(soap, ns2__Bye, "-d:ns2__Bye", NULL)
	|| soap_body_end_out(soap)
	|| soap_envelope_end_out(soap)
	|| soap_end_send(soap))
	{
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns2__Hello(struct soap *soap)
{	struct __ns2__Hello soap_tmp___ns2__Hello;
	struct d__ResolveType ns1__HelloResponse;
	soap_default_d__ResolveType(soap, &ns1__HelloResponse);
	soap_default___ns2__Hello(soap, &soap_tmp___ns2__Hello);
	soap->encodingStyle = NULL;
	if (!soap_get___ns2__Hello(soap, &soap_tmp___ns2__Hello, "-ns2:Hello", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns2__Hello(soap, soap_tmp___ns2__Hello.ns1__Hello, &ns1__HelloResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	soap_serialize_d__ResolveType(soap, &ns1__HelloResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_d__ResolveType(soap, &ns1__HelloResponse, "ns1:HelloResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns2__Bye(struct soap *soap)
{	struct __ns2__Bye soap_tmp___ns2__Bye;
	struct d__ResolveType ns1__ByeResponse;
	soap_default_d__ResolveType(soap, &ns1__ByeResponse);
	soap_default___ns2__Bye(soap, &soap_tmp___ns2__Bye);
	soap->encodingStyle = NULL;
	if (!soap_get___ns2__Bye(soap, &soap_tmp___ns2__Bye, "-ns2:Bye", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns2__Bye(soap, soap_tmp___ns2__Bye.ns1__Bye, &ns1__ByeResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
	soap_serialize_d__ResolveType(soap, &ns1__ByeResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if (soap->mode & SOAP_IO_LENGTH)
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_d__ResolveType(soap, &ns1__ByeResponse, "ns1:ByeResponse", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns3__Probe(struct soap *soap)
{	
	char _HwId[INFO_LENGTH];
	char macaddr[MACH_ADDR_LENGTH];
	struct __ns3__Probe soap_tmp___ns3__Probe;
	struct d__ProbeMatchesType ns1__ProbeResponse;
	soap_default_d__ProbeMatchesType(soap, &ns1__ProbeResponse);
	soap_default___ns3__Probe(soap, &soap_tmp___ns3__Probe);
	soap->encodingStyle = NULL;
	if (!soap_get___ns3__Probe(soap, &soap_tmp___ns3__Probe, "-ns3:Probe", NULL)){
		return soap->error;
	}
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns3__Probe(soap, soap_tmp___ns3__Probe.ns1__Probe, &ns1__ProbeResponse);
	if (soap->error){
		return soap->error;
	}
	soap_serializeheader(soap);
	soap_serialize_d__ProbeMatchesType(soap, &ns1__ProbeResponse);
	if (soap_begin_count(soap))
		return soap->error;
        soap->header->wsa__To = "http://schemas.xmlsoap.org/ws/2004/08/addressing/role/anonymous";
        soap->header->wsa__Action = "http://schemas.xmlsoap.org/ws/2005/04/discovery/ProbeMatches";
	soap->header->wsa__RelatesTo = (struct wsa__Relationship*)soap_malloc(soap, sizeof(struct wsa__Relationship));
	soap->header->wsa__RelatesTo->__item = soap->header->wsa5__MessageID;
	...
	if (soap->mode & SOAP_IO_LENGTH)
	{
		if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_d__ProbeMatchesType(soap, &ns1__ProbeResponse, "d:ProbeMatches", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns4__GetSupportedRules(struct soap *soap)
{	struct __ns4__GetSupportedRules soap_tmp___ns4__GetSupportedRules;
	...
	soap_default___ns4__GetSupportedRules(soap, &soap_tmp___ns4__GetSupportedRules);
	soap->encodingStyle = NULL;
	if (!soap_get___ns4__GetSupportedRules(soap, &soap_tmp___ns4__GetSupportedRules, "-ns4:GetSupportedRules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns4__GetSupportedRules(soap, soap_tmp___ns4__GetSupportedRules.tan__GetSupportedRules, &tan__GetSupportedRulesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns4__CreateRules(struct soap *soap)
{	struct __ns4__CreateRules soap_tmp___ns4__CreateRules;
	...
	soap_default___ns4__CreateRules(soap, &soap_tmp___ns4__CreateRules);
	soap->encodingStyle = NULL;
	if (!soap_get___ns4__CreateRules(soap, &soap_tmp___ns4__CreateRules, "-ns4:CreateRules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns4__CreateRules(soap, soap_tmp___ns4__CreateRules.tan__CreateRules, &tan__CreateRulesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns4__DeleteRules(struct soap *soap)
{	struct __ns4__DeleteRules soap_tmp___ns4__DeleteRules;
	...
	soap_default___ns4__DeleteRules(soap, &soap_tmp___ns4__DeleteRules);
	soap->encodingStyle = NULL;
	if (!soap_get___ns4__DeleteRules(soap, &soap_tmp___ns4__DeleteRules, "-ns4:DeleteRules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns4__DeleteRules(soap, soap_tmp___ns4__DeleteRules.tan__DeleteRules, &tan__DeleteRulesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns4__GetRules(struct soap *soap)
{	struct __ns4__GetRules soap_tmp___ns4__GetRules;
	...
	soap_default___ns4__GetRules(soap, &soap_tmp___ns4__GetRules);
	soap->encodingStyle = NULL;
	if (!soap_get___ns4__GetRules(soap, &soap_tmp___ns4__GetRules, "-ns4:GetRules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns4__GetRules(soap, soap_tmp___ns4__GetRules.tan__GetRules, &tan__GetRulesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns4__ModifyRules(struct soap *soap)
{	struct __ns4__ModifyRules soap_tmp___ns4__ModifyRules;
	...
	soap_default___ns4__ModifyRules(soap, &soap_tmp___ns4__ModifyRules);
	soap->encodingStyle = NULL;
	if (!soap_get___ns4__ModifyRules(soap, &soap_tmp___ns4__ModifyRules, "-ns4:ModifyRules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns4__ModifyRules(soap, soap_tmp___ns4__ModifyRules.tan__ModifyRules, &tan__ModifyRulesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns5__GetSupportedAnalyticsModules(struct soap *soap)
{	struct __ns5__GetSupportedAnalyticsModules soap_tmp___ns5__GetSupportedAnalyticsModules;
	...
	soap_default___ns5__GetSupportedAnalyticsModules(soap, &soap_tmp___ns5__GetSupportedAnalyticsModules);
	soap->encodingStyle = NULL;
	if (!soap_get___ns5__GetSupportedAnalyticsModules(soap, &soap_tmp___ns5__GetSupportedAnalyticsModules, "-ns5:GetSupportedAnalyticsModules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns5__GetSupportedAnalyticsModules(soap, soap_tmp___ns5__GetSupportedAnalyticsModules.tan__GetSupportedAnalyticsModules, &tan__GetSupportedAnalyticsModulesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns5__CreateAnalyticsModules(struct soap *soap)
{	struct __ns5__CreateAnalyticsModules soap_tmp___ns5__CreateAnalyticsModules;
	...
	soap_default___ns5__CreateAnalyticsModules(soap, &soap_tmp___ns5__CreateAnalyticsModules);
	soap->encodingStyle = NULL;
	if (!soap_get___ns5__CreateAnalyticsModules(soap, &soap_tmp___ns5__CreateAnalyticsModules, "-ns5:CreateAnalyticsModules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns5__CreateAnalyticsModules(soap, soap_tmp___ns5__CreateAnalyticsModules.tan__CreateAnalyticsModules, &tan__CreateAnalyticsModulesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns5__DeleteAnalyticsModules(struct soap *soap)
{	struct __ns5__DeleteAnalyticsModules soap_tmp___ns5__DeleteAnalyticsModules;
	...
	soap_default___ns5__DeleteAnalyticsModules(soap, &soap_tmp___ns5__DeleteAnalyticsModules);
	soap->encodingStyle = NULL;
	if (!soap_get___ns5__DeleteAnalyticsModules(soap, &soap_tmp___ns5__DeleteAnalyticsModules, "-ns5:DeleteAnalyticsModules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns5__DeleteAnalyticsModules(soap, soap_tmp___ns5__DeleteAnalyticsModules.tan__DeleteAnalyticsModules, &tan__DeleteAnalyticsModulesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns5__GetAnalyticsModules(struct soap *soap)
{	struct __ns5__GetAnalyticsModules soap_tmp___ns5__GetAnalyticsModules;
	...
	soap_default___ns5__GetAnalyticsModules(soap, &soap_tmp___ns5__GetAnalyticsModules);
	soap->encodingStyle = NULL;
	if (!soap_get___ns5__GetAnalyticsModules(soap, &soap_tmp___ns5__GetAnalyticsModules, "-ns5:GetAnalyticsModules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns5__GetAnalyticsModules(soap, soap_tmp___ns5__GetAnalyticsModules.tan__GetAnalyticsModules, &tan__GetAnalyticsModulesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns5__ModifyAnalyticsModules(struct soap *soap)
{	struct __ns5__ModifyAnalyticsModules soap_tmp___ns5__ModifyAnalyticsModules;
	...
	soap_default___ns5__ModifyAnalyticsModules(soap, &soap_tmp___ns5__ModifyAnalyticsModules);
	soap->encodingStyle = NULL;
	if (!soap_get___ns5__ModifyAnalyticsModules(soap, &soap_tmp___ns5__ModifyAnalyticsModules, "-ns5:ModifyAnalyticsModules", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns5__ModifyAnalyticsModules(soap, soap_tmp___ns5__ModifyAnalyticsModules.tan__ModifyAnalyticsModules, &tan__ModifyAnalyticsModulesResponse);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
{	struct __tds__GetZeroConfiguration soap_tmp___tds__GetZeroConfiguration;
	...
	//if(tds__GetZeroConfigurationResponse.ZeroConfiguration)
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns9__CreatePullPointSubscription(struct soap *soap)
{
        struct __ns9__CreatePullPointSubscription soap_tmp___ns9__CreatePullPointSubscription;
        struct _ns1__CreatePullPointSubscriptionResponse ns1__CreatePullPointSubscriptionResponse;
        soap_default__ns1__CreatePullPointSubscriptionResponse(soap, &ns1__CreatePullPointSubscriptionResponse);
        soap_default___ns9__CreatePullPointSubscription(soap, &soap_tmp___ns9__CreatePullPointSubscription);
        soap->encodingStyle = NULL;
        if (!soap_get___ns9__CreatePullPointSubscription(soap, &soap_tmp___ns9__CreatePullPointSubscription, "-tet:CreatePullPointSubscription", NULL))
                return soap->error;
        if (soap_body_end_in(soap)
         || soap_envelope_end_in(soap)
         || soap_end_recv(soap))
        ...
        soap->error = __ns9__CreatePullPointSubscription(soap, soap_tmp___ns9__CreatePullPointSubscription.ns1__CreatePullPointSubscription, &ns1__CreatePullPointSubscriptionResponse);
        if (soap->error)
                return soap->error;
        soap_serializeheader(soap);
        soap_serialize__ns1__CreatePullPointSubscriptionResponse(soap, &ns1__CreatePullPointSubscriptionResponse);
        if (soap_begin_count(soap))
                return soap->error;
        if (soap->mode & SOAP_IO_LENGTH)
        {       if (soap_envelope_begin_out(soap)
                 || soap_putheader(soap)
                 || soap_body_begin_out(soap)
                 || soap_put__ns1__CreatePullPointSubscriptionResponse(soap, &ns1__CreatePullPointSubscriptionResponse, "tet:CreatePullPointSubscriptionResponse", NULL)
                 || soap_body_end_out(soap)
                 || soap_envelope_end_out(soap))
                         return soap->error;
        };
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns10__Renew(struct soap *soap)
{       struct __ns10__Renew soap_tmp___ns10__Renew;
        struct _ns6__RenewResponse ns6__RenewResponse;
        soap_default__ns6__RenewResponse(soap, &ns6__RenewResponse);
        soap_default___ns10__Renew(soap, &soap_tmp___ns10__Renew);
        soap->encodingStyle = NULL;
        if (!soap_get___ns10__Renew(soap, &soap_tmp___ns10__Renew, "-ns10:Renew", NULL))
                return soap->error;
        if (soap_body_end_in(soap)
         || soap_envelope_end_in(soap)
         || soap_end_recv(soap))
                return soap->error;
        soap->error = __ns10__Renew(soap, soap_tmp___ns10__Renew.ns6__Renew, &ns6__RenewResponse);
        if (soap->error)
                return soap->error;
        soap_serializeheader(soap);
        soap_serialize__ns6__RenewResponse(soap, &ns6__RenewResponse);
        if (soap_begin_count(soap))
                return soap->error;
        if (soap->mode & SOAP_IO_LENGTH)
        {       if (soap_envelope_begin_out(soap)
                 || soap_putheader(soap)
                 || soap_body_begin_out(soap)
                 || soap_put__ns6__RenewResponse(soap, &ns6__RenewResponse, "ns6:RenewResponse", NULL)
                 || soap_body_end_out(soap)
                 || soap_envelope_end_out(soap))
                         return soap->error;
        };
...
{	
        struct  _ns6__Notify  ns6__Notify;
	soap_default___ns6__Notify(soap, &ns6__Notify);
	soap->encodingStyle = NULL;
       	soap_begin(soap);
       	soap->error = __ns12__Notify(soap, &ns6__Notify);
	if (soap->error)
		return soap->error;
	soap_serializeheader(soap);

	soap_serialize__ns6__Notify(soap,&ns6__Notify);
	if (soap_begin_count(soap))
	{
		return soap->error;
	}
	if (soap->mode & SOAP_IO_LENGTH)
	{
		if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put___ns6__Notify(soap, &ns6__Notify, "ns6:Notify", NULL)
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
		{
			 return soap->error;
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns12__Notify(struct soap *soap)
{	struct __ns12__Notify soap_tmp___ns12__Notify;
	soap_default___ns12__Notify(soap, &soap_tmp___ns12__Notify);
	soap->encodingStyle = NULL;
	if (!soap_get___ns12__Notify(soap, &soap_tmp___ns12__Notify, "-ns12:Notify", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __ns12__Notify(soap, soap_tmp___ns12__Notify.ns6__Notify);
	if (soap->error)
		return soap->error;
	return soap_closesock(soap);
}
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns9__GetEventProperties(struct soap *soap)
{       struct __ns9__GetEventProperties soap_tmp___ns9__GetEventProperties;
        struct _ns1__GetEventPropertiesResponse ns1__GetEventPropertiesResponse;
        soap_default__ns1__GetEventPropertiesResponse(soap, &ns1__GetEventPropertiesResponse);
        soap_default___ns9__GetEventProperties(soap, &soap_tmp___ns9__GetEventProperties);
        soap->encodingStyle = NULL;
        if (!soap_get___ns9__GetEventProperties(soap, &soap_tmp___ns9__GetEventProperties, "-ns9:GetEventProperties", NULL))
                return soap->error;
        if (soap_body_end_in(soap)
         || soap_envelope_end_in(soap)
         || soap_end_recv(soap))
...
//	soap->header = (struct SOAP_ENV__Header*)soap_malloc(soap,sizeof(struct SOAP_ENV__Header)); 
	soap->header->wsa5__Action = (char*)soap_malloc(soap,sizeof(char)*LARGE_INFO_LENGTH);
        ...
        soap->error = __ns9__GetEventProperties(soap, soap_tmp___ns9__GetEventProperties.ns1__GetEventProperties, &ns1__GetEventPropertiesResponse);
        if (soap->error)
                return soap->error;
        soap_serializeheader(soap);
        soap_serialize__ns1__GetEventPropertiesResponse(soap, &ns1__GetEventPropertiesResponse);
        if (soap_begin_count(soap))
                return soap->error;
        if (soap->mode & SOAP_IO_LENGTH)
        {       if (soap_envelope_begin_out(soap)
                 || soap_putheader(soap)
                 || soap_body_begin_out(soap)
                 || soap_put__ns1__GetEventPropertiesResponse(soap, &ns1__GetEventPropertiesResponse, "tet:GetEventPropertiesResponse", NULL)
                 || soap_body_end_out(soap)
                 || soap_envelope_end_out(soap))
                         return soap->error;
        };
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns10__Unsubscribe(struct soap *soap)
{       struct __ns10__Unsubscribe soap_tmp___ns10__Unsubscribe;
        struct _ns6__UnsubscribeResponse ns6__UnsubscribeResponse;
        soap_default__ns6__UnsubscribeResponse(soap, &ns6__UnsubscribeResponse);
        soap_default___ns10__Unsubscribe(soap, &soap_tmp___ns10__Unsubscribe);
        soap->encodingStyle = NULL;
        if (!soap_get___ns10__Unsubscribe(soap, &soap_tmp___ns10__Unsubscribe, "-ns10:Unsubscribe", NULL))
                return soap->error;
        if (soap_body_end_in(soap)
         || soap_envelope_end_in(soap)
         || soap_end_recv(soap))
        ...
        soap->error = __ns10__Unsubscribe(soap, soap_tmp___ns10__Unsubscribe.ns6__Unsubscribe, &ns6__UnsubscribeResponse);
        if (soap->error)
                return soap->error;
        soap_serializeheader(soap);
        soap_serialize__ns6__UnsubscribeResponse(soap, &ns6__UnsubscribeResponse);
        if (soap_begin_count(soap))
                return soap->error;
        if (soap->mode & SOAP_IO_LENGTH)
        {       if (soap_envelope_begin_out(soap)
                 || soap_putheader(soap)
                 || soap_body_begin_out(soap)
                 || soap_put__ns6__UnsubscribeResponse(soap, &ns6__UnsubscribeResponse, "ns6:UnsubscribeResponse", NULL)
                 || soap_body_end_out(soap)
                 || soap_envelope_end_out(soap))
                         return soap->error;
        };
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns8__SetSynchronizationPoint(struct soap *soap)
{       struct __ns8__SetSynchronizationPoint soap_tmp___ns8__SetSynchronizationPoint;
        ...
        soap->encodingStyle = NULL;
        if (!soap_get___ns8__SetSynchronizationPoint(soap, &soap_tmp___ns8__SetSynchronizationPoint, "-tet:SetSynchronizationPoint", NULL))
                return soap->error;
        if (soap_body_end_in(soap)
         || soap_envelope_end_in(soap)
         || soap_end_recv(soap))
                return soap->error;
        soap->error = __ns8__SetSynchronizationPoint(soap, soap_tmp___ns8__SetSynchronizationPoint.ns1__SetSynchronizationPoint, &ns1__SetSynchronizationPointResponse);
        if (soap->error)
                return soap->error;
        soap_serializeheader(soap);
        ...
        {       if (soap_envelope_begin_out(soap)
                 || soap_putheader(soap)
                 || soap_body_begin_out(soap)
                 || soap_put__ns1__SetSynchronizationPointResponse(soap, &ns1__SetSynchronizationPointResponse, "tet:SetSynchronizationPointResponse", NULL)
                 || soap_body_end_out(soap)
                 || soap_envelope_end_out(soap))
                         return soap->error;
        };
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns11__Subscribe(struct soap *soap)
{
        struct __ns11__Subscribe soap_tmp___ns11__Subscribe;
        struct _ns6__SubscribeResponse ns6__SubscribeResponse;
        soap_default__ns6__SubscribeResponse(soap, &ns6__SubscribeResponse);
        soap_default___ns11__Subscribe(soap, &soap_tmp___ns11__Subscribe);
        soap->encodingStyle = NULL;
        if (!soap_get___ns11__Subscribe(soap, &soap_tmp___ns11__Subscribe, "-Subscribe", NULL))
                return soap->error;
        if (soap_body_end_in(soap)
         || soap_envelope_end_in(soap)
         || soap_end_recv(soap))
	        ...
	        soap->error = __ns11__Subscribe(soap, soap_tmp___ns11__Subscribe.ns6__Subscribe, &ns6__SubscribeResponse);
        if (soap->error)
                return soap->error;
        soap_serializeheader(soap);
        soap_serialize__ns6__SubscribeResponse(soap, &ns6__SubscribeResponse);
        if (soap_begin_count(soap))
                return soap->error;
        if (soap->mode & SOAP_IO_LENGTH)
        {       if (soap_envelope_begin_out(soap)
                 || soap_putheader(soap)
                 || soap_body_begin_out(soap)
                 || soap_put__ns6__SubscribeResponse(soap, &ns6__SubscribeResponse, "ns6:SubscribeResponse", NULL)
                 || soap_body_end_out(soap)
                 || soap_envelope_end_out(soap))
                         return soap->error;
        };
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___ns8__PullMessages(struct soap *soap)
{       struct __ns8__PullMessages soap_tmp___ns8__PullMessages;
        struct _ns1__PullMessagesResponse ns1__PullMessagesResponse;
        soap_default__ns1__PullMessagesResponse(soap, &ns1__PullMessagesResponse);
        soap_default___ns8__PullMessages(soap, &soap_tmp___ns8__PullMessages);
        soap->encodingStyle = NULL;
        if (!soap_get___ns8__PullMessages(soap, &soap_tmp___ns8__PullMessages, "-tet:PullMessages", NULL))
                return soap->error;
        if (soap_body_end_in(soap)
         || soap_envelope_end_in(soap)
         || soap_end_recv(soap))
                return soap->error;
        soap->error = __ns8__PullMessages(soap, soap_tmp___ns8__PullMessages.ns1__PullMessages, &ns1__PullMessagesResponse);
        if (soap->error)
                return soap->error;
        soap_serializeheader(soap);
        soap_serialize__ns1__PullMessagesResponse(soap, &ns1__PullMessagesResponse);
        if (soap_begin_count(soap))
                return soap->error;
        if (soap->mode & SOAP_IO_LENGTH)
        {       if (soap_envelope_begin_out(soap)
                 || soap_putheader(soap)
                 || soap_body_begin_out(soap)
                 || soap_put__ns1__PullMessagesResponse(soap, &ns1__PullMessagesResponse, "tet:PullMessagesResponse", NULL)
                 || soap_body_end_out(soap)
                 || soap_envelope_end_out(soap))
                         return soap->error;
        };
