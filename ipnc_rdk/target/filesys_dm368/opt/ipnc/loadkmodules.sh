...
insmod /opt/ipnc/modules/des_generic.ko
insmod /opt/ipnc/modules/md5.ko
insmod /opt/ipnc/modules/sha1_generic.ko
insmod /opt/ipnc/modules/libcrc32c.ko
#fs
...
insmod /opt/ipnc/modules/libiscsi_tcp.ko
insmod /opt/ipnc/modules/iscsi_tcp.ko
insmod /opt/ipnc/modules/musb_hdrc.ko
insmod /opt/ipnc/modules/cppi_dma.ko
insmod /opt/ipnc/modules/davinci.ko
